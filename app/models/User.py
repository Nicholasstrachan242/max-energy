...
class User(UserMixin, db.Model):
    ...
    mfa_secret = db.Column(db.LargeBinary, nullable=True) # MFA secret generated by pyotp.
    mfa_enabled = db.Column(db.Boolean, nullable=False, default=False) # this is enabled when user successfully sets up MFA. Can only be disabled via admin script.
